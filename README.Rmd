...
```{r troops-2, fig.width=10, fig.height=2.5}
ggplot(troops, aes(x = long, y = lat, group = group, 
...
```{r troops-3, fig.width=10, fig.height=2.5}
ggplot(troops, aes(x = long, y = lat, group = group, 
                   color = direction, size = survivors)) +
...
```{r troops-4, fig.width=10, fig.height=2.5}
ggplot(troops, aes(x = long, y = lat, group = group, 
                   color = direction, size = survivors)) +
  geom_path(lineend = "round") +
...
```{r troops-5, fig.width=10, fig.height=2.5}
ggplot(troops, aes(x = long, y = lat, group = group, 
                   color = direction, size = survivors)) +
  geom_path(lineend = "round") +
  scale_size(range = c(0.5, 15)) + 
...
```{r troops-map-1, fig.width=10, fig.height=2.5}
ggplot() +
...
```{r troops-map-2, fig.width=10, fig.height=2.5}
ggplot() +
  geom_path(data = troops, aes(x = long, y = lat, group = group, 
                               color = direction, size = survivors),
            lineend = "round") +
...
```{r europe-minard, fig.width=10, fig.height=6}
ggmap(march.1812.europe.map.wc) +
  geom_path(data = troops, aes(x = long, y = lat, group = group, 
                               color = direction, size = survivors),
            lineend = "round") +
...
```{r russia-minard, message=FALSE, fig.width=10, fig.height=4}
...
```{r temps-1, fig.width=10, fig.height=4}
...
```{r align-example, fig.width=6, fig.height=4}
...
```{r align-example-good, fig.width=6, fig.height=4}
...
```{r adjust-panels, fig.width=10, fig.height=5.5}
...
```{r combined-simple, fig.width=10, fig.height=4.75}
# No map this time
